# Developer Task: Phase 8 Trigger Correctness & Context Autocomplete

Target Branch: `feature/nlp-autocomplete-hardening-phase-8`

You are the Lead Developer. Your task is to implement trigger parsing corrections and context-aware auto-suggestions. Do NOT follow Codex; write clean, standalone TypeScript.

---

## 1. NLP Trigger Parsing (lib/nlParser.ts)
Refactor `matchEvent()`:
...
## 2. Context-Aware Autocomplete UI (components/ChatBox.tsx)
