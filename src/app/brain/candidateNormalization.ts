/**
 * GENERATED from packages/workflow-brain/src/candidateNormalization.ts — DO NOT EDIT BY HAND.
...
import type { ParsedClause } from "../core/parserClauses";
import {
  staticVocabularySnapshot,
  stableVocabularyHash,
  groundRule,
  groundValue,
} from "../core/parserGrounding";
import type { GroundingVerdict, VocabularySnapshot } from "../core/parserGrounding";
import {
  condFieldKind,
  isFormFieldRef,
  isScopeRef,
...
import { hasBlockingIssues, lintRuleIssues } from "../core/ruleLinter";
import { isParseEnvelope } from "../core/parserProvenance";
