/**
 * GENERATED from packages/workflow-brain/src/orchestrator.ts — DO NOT EDIT BY HAND.
 ...
 */
import type { ParseOptions, ParseResult } from "../core/nlParser";
import { isParseEnvelope, makeEnvelope, PARSER_ENGINE_VERSION } from "../core/parserProvenance";
import type { EngineMode, ParseEnvelope, ParserProvenance } from "../core/parserProvenance";
